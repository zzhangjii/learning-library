...
```
$ curl -sS https://github.com/oracle/learning-library/tree/master/data-management-library/autonomous-transaction-processing/serverless/scripts/600/ojdbc8-master.zip > ojdbc8.zip

$ curl -sS https://github.com/oracle/learning-library/tree/master/data-management-library/autonomous-transaction-processing/serverless/scripts/600/atpjava-master.zip > ATPJava.zip
```
