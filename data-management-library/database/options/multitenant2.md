...
- [Setup](#setup)
- [Section 1: Instant SaaS](#section-1-pdb-hot-clones)
- [section 2: PDB Exploration](#section-2-pdb-refresh)
- [Section 3: Upgrade from v1 to v2](#section-3-pdb-relocation)
- [Section 4: Containers Queries](#section-3-pdb-relocation)
- [Section 5: Application Root Clones and Compatibility](#section-3-pdb-relocation)
- [Section 6: Expansion Beyond Single CDB and Application Root Replicas](#section-3-pdb-relocation)
- [Section 7: Durable Location Transparency](#section-3-pdb-relocation)
- [Section 8: Data Sharing](#section-3-pdb-relocation)
- [Section 9: Application Patches](#section-3-pdb-relocation)
- [Section 10: DBA Views](#section-3-pdb-relocation)
- [Section 11: Diagnosing, Correcting Problems, and Restarting Sync](#section-3-pdb-relocation)
- [Section 3: Upgrade from v1 to v2](#section-3-pdb-relocation)
