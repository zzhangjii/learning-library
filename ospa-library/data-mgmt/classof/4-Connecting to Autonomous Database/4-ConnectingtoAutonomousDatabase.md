...
using the ADB Database account that was created for you by following these
steps.
...
In this section you will connect to OML with the user that was created for you in the earlier lab and you will run the same query in OML you just ran above in SQL Developer to test your connection. In a later lab you will explore more about OML.
