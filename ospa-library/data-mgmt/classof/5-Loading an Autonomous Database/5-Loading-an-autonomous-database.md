...
information they already have, many times from flat files.
...
1. In SQL Developer, connect to your database. Double Click on the connection you
defined

![](media/7c80c63288eaead335faaf3213b2ae4d.png)
<p align="center">Figure 1-1</p>

2. In the pop-up window, provide the username and password for your database user,
...
stored the file you just downloaded. Select the file and click **Open** once you
find it.
...
eraser button) and copy and paste the SQL below and run it like you did before:
