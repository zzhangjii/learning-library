...
[Lab Guide Overview 6](#_Toc1645573)

[Lab 1: Getting Started 7](#section)

[1: Home Page 7](#lab-1-getting-started-1)

[2: Navigating 7](#_Toc1645578)

[Lab 2: Loading Data 8](#section)

[Lab 3: Building Visualizations](#section)

[Lab 4: Augmented Analytics](#section)

[Lab 5: Chart Properties 22](#section)

[Lab 6: Colors….. 28](#section)

[Lab 7: Filters 31](#section)

[Lab 8: Canvas Properties 36](#section)

[Lab 9: Augmented Analytics 4](#section)

[Lab 10: Collaboration 4](#section)
...
[Lab 13: Data Recommendations on Multiple Data Sets 5](#section)

[Lab 14: Enhanced Insights on Multiple Data Sets 60](#section)
...
Each lab allows you to get hands-on exposure working with “LAB Cloud”
products. Upon completion of each lab, a group review of the key
...
attrition data and with sales data which will help to expose you to
...
7.  You should now see the new HCM\_Terminations data set in the “What’s
    New” area of the Home Page. ![](./media/image15.png) Figure 2.8
...
8.  Now, click on the “Connect to Your Data” option to create a data set
    ...
    ![](./media/image16.png) Figure 2.9 ![](./media/image17.png) Figure
    2.10
...
9.  Give the data set a logical name such as,
    ...
    ![](./media/image18.png)Figure 2.11

10. Because we used the Data Set creation Wizard, or new data set is
    ...
    ![](./media/image20.png) Figure 2.13 ![](./media/image21.png) Figure
    2.14
...
12. Rename this new column by clicking the options icon on the right of
    ...
    ![](./media/image23.png) ![](./media/image24.png) Figure 2.16
...
17. Click the Navigator icon ![](./media/image25.png) Figure 2.17
...
1.  Click the create button on the upper right of the Home Page or click
    ...
    to build visualizations. ![](./media/image15.png) Figure 3.1
...
18. Create another (slightly more complicated) calculation for the
    Average \# of Terminations by Department. ![](./media/image39.png)
    Figure 3.13
...
review different visualization or chart types and manipulating data. We
...
11. By default, the Title property will be Auto. Click Auto and select
    ...
    ![](./media/image56.png) Figure 5.8 ![](./media/image57.png) Figure
    5.9
...
6.  You can also specify colors for specific attribute or visualization.
...
24. Click Drill and then click Manager ID.
    ...
    ![](./media/image84.png) Figure 7.14 ![](./media/image85.png) Figure
    7.15
...
26. Click the undo button. ![](./media/image86.png) Figure 7.16
...
27. For the Termination Department, enable Show Total which will display
    ...
    ![](./media/image108.png) Figure 8.23
...
In this lab you will prepare data, load multiple data sets. You will
...
3.  A blank canvas is displayed where you can immediately begin to build
    ...
    ![](./media/image134.png) Figure 12.2
...
4.  This takes you to the prepare area with a Script Pane on the left
    ...
    ![](./media/image135.png) Figure 12.3
...
10. Scroll to the left to the Order Priority Column. Notice the
    ...
    ![](./media/image138.png) Figure 12.6
...
11. Name the first group Low and include the values Low and Not
    ...
    ![](./media/image139.png) Figure 12.7

12. Click the + sign next to Group to add another Group.
    
    ![](./media/image140.png) Figure 12.8
...
13. Click Add Step
    ...
    ![](./media/image141.png)Figure 12.9
...
14. Scroll to the Quantity Ordered column and build another “group
    ...
    ![](./media/image142.png) Figure 12.10
...
15. Create four bins for order size. Name the first bin Small for orders
    ...
    ![](./media/image143.png) Figure 12.11
...
19. There are now two data set tabs on the bottom of the screen. You are
    ...
    ![](./media/image146.png) Figure 12.14
...
23. Notice that the enrichment actions that you performed on the data
    ...
    ![](./media/image149.png) Figure 12.17
