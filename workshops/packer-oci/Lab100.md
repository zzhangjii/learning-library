...
If you click the link in your "Getting started" e-mail (rather than navigating to cloud.oracle.com), it will have auto-populated your Cloud Account name, but routed you to the Dashboard:

  ![](images/Lab100/My_Services_-_Dashboard.png)  

From the Dashboard, you can quickly navigate to the Console, using the menu shown above in red. 

- open the Services and select "compute" to get to the Compute Console: 
  
   ![](images/Lab100/My_Services_-_Dashboard_nav.png)  
