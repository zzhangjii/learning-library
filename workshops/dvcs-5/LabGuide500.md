...
7. Adjust the visualizations and Save Project.**  
    Steps required:
...
DVD 4.0 also has more ways to share than in previous versions.The share feature enables you to share a visualization, canvas, or story with others as a DV file, by email, a printed page, and on cloud. 
