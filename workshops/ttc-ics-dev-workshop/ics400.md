...
**2.3.3** Click and drag the connection just under the *lookupItemName* invocation

(_Note that the connector tray will go away after you select your connector and start to drag it_)

![](images/400/image016.png)

**2.3.4** Drop the connection on top of the green plus sign landing zone which will appear just below the *lookupItemName* invocation
...
**2.6.17** It is a good practice to occasionally save your work during a long mapping exercise.  Click on the *Validate* button in the upper right of the mapper to save your work up to this point.
...
**2.7.8** If you want to ensure what the path to the target element you just searched for is, you can linger over the element to see that what it's path is as shown in the screenshot below:
...
**2.9.10** Click on the *Validate* button in the upper right of the mapping editor.
